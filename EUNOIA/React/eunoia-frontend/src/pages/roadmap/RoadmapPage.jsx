...
const RoadmapPage = () => {
    const meta = {
        ...
        status: "EUNOIA 철학 강화",
        tags: ["감정 표현 방식 개선", "UI 안정성"],
        comment: "이번 업데이트(v1.1.2)는 EUNOIA가 감정에 말을 거는 방식을 다시 정리한 변화이자, 앞으로 확장될 기능들을 위한 철학적 기틀을 다지는 과정입니다.\n\n v1.1.1에서 감정 분석 결과가 ‘어떤 순서로, 어떻게 읽히는가’에 집중했다면, 이번 업데이트에서는 그 다음 질문을 마주했습니다.\n\n \"이 말은, 정말 감정 옆에 서 있는 말일까?\"\n\n 그동안 EUNOIA의 메시지는 사용자에게 따뜻한 응원을 건네는 데 초점을 두고 있었습니다. 하지만 사용 경험을 다시 돌아보며, 무심코 건네진 위로가 때로는 감정을 충분히 바라볼 시간을 주지 못할 수도 있겠다는 고민이 생겼습니다.\n\n 이번 업데이트에서는 메시지의 방향을 ‘응원’에서 ‘동행’으로 조정했습니다. 감정을 좋고 나쁨으로 판단하거나, 해결의 방향을 제시하기보다 지금의 감정을 있는 그대로 비추고, 사용자가 스스로 한 걸음 떨어진 자리에서 마음을 바라볼 수 있도록 돕는 표현에 집중했습니다.\n\n 이에 따라 기존의 [EUNOIA가 당신에게 해주고 싶은 말] 카드는 [지금의 감정을 비춰보는 말]이라는 이름으로 변경되었으며, 메시지 또한 해석이나 결론보다 관찰과 병존을 중심으로 재구성되었습니다.\n\n 이 변화는 이후 추가될 새로운 기능, 가칭 ‘EUNOIA의 거울’을 위한 준비이기도 합니다. EUNOIA가 감정을 대신 말해주는 존재가 아니라, 사용자가 자신의 감정을 스스로 마주할 수 있는 시점을 열어주는 관찰자로 남기 위해 자기이해적이고 비개입적인 태도를 더욱 분명히 다듬는 단계입니다.\n\n EUNOIA는 여전히 정답을 제시하지 않습니다. 대신, 감정이 지나가는 자리에 조용히 함께 머무는 역할을 선택했습니다.\n\n이번 업데이트가 자신의 감정을 ‘설명받는 대상’이 아니라 ‘스스로 비춰볼 수 있는 대상’으로 느끼는 데 작은 도움이 되길 바랍니다.",
    };
    ...
    const issues = [
        {
            title: "EUNOIA 새로운 기능",
            desc: "유노이아가 비춰줄 여러분의 모습을 선으로 이어지게 만들어드릴게요.",
            severity: "warn",
            hint: "새로운 기능에 대한 DB 도메인 설계중",
        },
    ];
    ...
    const roadmap = [
        {
            ...
            title: "다음 업데이트 (예정)",
            items: [
                "EUNOIA에 비춰보이는 당신은 어떤 모습일까요? - EUNOIA가 거울이 되어 보여드릴게요.",
            ],
        },
        {
            quarter: "SOON",
